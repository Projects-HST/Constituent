package com.gms.constituent.customview;
...
public class CustomOtpEditText extends LinearLayout {
    ...
    private void styleEditTexts(TypedArray styles) {
        ...
        int backgroundColor =
                styles.getColor(R.styleable.OtpEditText_text_background_color, getResources().getColor(R.color.white));
        if (styles.getColor(R.styleable.OtpEditText_text_background_color, getResources().getColor(R.color.white))
